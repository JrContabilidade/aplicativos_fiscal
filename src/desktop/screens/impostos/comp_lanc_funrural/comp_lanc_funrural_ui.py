...
class Ui_CompLancFunrural(object):
    def setupUi(self, CompLancFunrural):
        if not CompLancFunrural.objectName():
            CompLancFunrural.setObjectName(u"CompLancFunrural")
        ...
        self.btn_arq_funrural.setObjectName(u"btn_arq_funrural")
        ...
        self.frm_empresa.setObjectName(u"frm_empresa")
        ...
        self.lbl_data_inicio.setObjectName(u"lbl_data_inicio")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbl_data_inicio.sizePolicy().hasHeightForWidth())
        ...
        self.grp_chaves_lcto.setObjectName(u"grp_chaves_lcto")
        ...
        self.txt_chaves_lcto.setObjectName(u"txt_chaves_lcto")
        ...
        self.btn_baixar_modelo.setObjectName(u"btn_baixar_modelo")
    ...
    def retranslateUi(self, CompLancFunrural):
        CompLancFunrural.setWindowTitle(QCoreApplication.translate("CompLancFunrural", u"Comparar lan\u00e7amento Funrural", None))
        self.grp_arq_funrural.setTitle(QCoreApplication.translate("CompLancFunrural", u"Arquivo Funrural", None))
        self.btn_arq_funrural.setText(QCoreApplication.translate("CompLancFunrural", u"...", None))
        self.lbl_empresa.setText(QCoreApplication.translate("CompLancFunrural", u"Empresa", None))
        self.lbl_filial.setText(QCoreApplication.translate("CompLancFunrural", u"FIlial", None))
        self.frm_data.setTitle(QCoreApplication.translate("CompLancFunrural", u"Per\u00edodo dos Lan\u00e7amentos", None))
        self.lbl_data_inicio.setText(QCoreApplication.translate("CompLancFunrural", u"Data Inicio", None))
        self.lbl_data_final.setText(QCoreApplication.translate("CompLancFunrural", u"Data Final", None))
        self.grp_chaves_lcto.setTitle(QCoreApplication.translate("CompLancFunrural", u"Chave de Lan\u00e7amento Funrural", None))
        self.btn_copiar.setText(QCoreApplication.translate("CompLancFunrural", u"Copiar", None))
        self.btn_baixar_modelo.setText(QCoreApplication.translate("CompLancFunrural", u"Baixar Modelo", None))
        self.btn_limpar.setText(QCoreApplication.translate("CompLancFunrural", u"Limpar", None))
        self.btn_processar.setText(QCoreApplication.translate("CompLancFunrural", u"Processar", None))
    # retranslateUi
